 ...
 * @author FAIZAN RAZA
 */
public class Delete_Userid extends javax.swing.JFrame {
Connection con1;
    ...
    /**
     * Creates new form Delete_Userid
     */
...
public void fillCombo() {
    try {
        ...
        while (rs.next()) {
            ...
            comboStudentID.addItem(String.valueOf(userID));
        }
    } catch (SQLException ex) {
        Logger.getLogger(Delete_Userid.class.getName()).log(Level.SEVERE, null, ex);
    } finally {
        try {
            con1.close();
            rs.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_Userid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Userid().setVisible(true);
            }
        });
    }
